      ...
      <form className='flex flex-col gap-5' >
        ...
        <div className='flex flex-col gap-16'>
          ...
          <div className='flex flex-col  lg:flex-row gap-4 '>
                    <div className='flex gap-1 items-center rounded-[10px] border-[1px] p-0 sm:pl-5 sm:pr-5 sm:pt-1 sm:pb-1 border-[#D9D9D9] text-[12px] font-medium text-black'><FcGoogle  className=' text-2xl '/>Sign in with Google</div>
                    <div className='flex gap-1 items-center rounded-[10px] border-[1px] p-0 sm:pl-5 sm:pr-5 sm:pt-1 sm:pb-1 border-[#D9D9D9] text-[12px] font-medium text-black'><FaApple  className='text-2xl'/>Sign in with Apple</div>
                </div>
        </div>
        <div className='flex justify-center mt-6 '>
          <h2 className='font-medium text-sm'>Don't have an account? <span className='text-[#0F3DDE]
'>Sign Up</span></h2>
        </div>
      </form>
    </div>
